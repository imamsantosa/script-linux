...
tar -xzvf roundcubemail-1.2.1-complete.tar.gz -C /var/www/html
mv /var/www/html/roundcubemail-1.2.1/ /var/www/html/webmail
...
apt-get install php7.0-intl php7.0-ldap php7.0-json  php7.0-mbstring php-xml 
...
echo "konfigurasi Postfixadmin mengikuti http://postfixadmin.sourceforge.net/ "
echo "Konfigurasi/install roundcube mengikuti password di konfigurasi ini "
